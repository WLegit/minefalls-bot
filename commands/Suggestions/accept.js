...
module.exports.run = async (client, message, args) => {
    ...
    .then(async m => {
        ...
        message.channel.send(new Discord.MessageEmbed().setColor("GREEN").setDescription("Successfully accepted the suggestion | " + reason))
        .then(m => m.delete({ timeout: 5000 }))
        message.delete()
    })
    .catch(err => {
...
module.exports.help = {
	name: "accept",
	aliases: ["acc", "approve"],
	description: "Accept commmand for accepting suggestions in your server",
	usage: "accept <messageID>",
